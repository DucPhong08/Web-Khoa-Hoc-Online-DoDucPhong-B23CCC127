...
async function postOneNotification(user_id, title, message) {
    try {
        ...
        const response = await fetch(`${BASE_URL}/postOneNotification/${user_id}/${title}/${message}`, {
            method: 'POST',
            headers: {
...
export default postOneNotification;
